pipeline {
    ...
    stages {
        ...
        stage('SR Daily Multijob Data Model Run Phase'){
            stage('SR Daily ML Model Run'){
        ...
        stage('SR Daily Multijob Data Export Run Phase Orlin'){
            stage('SR Daily ML Data Export Orlin'){
        ...
        stage('SR Daily ML Data Orlin MIDDY'){
        ...
        stage('SR Daily Multijob Data Export Run Phase'){
            stage('SR Daily ML Data Export PP_Jim'){
            ...
            stage('SR Daily ML Data Export LAZARD'){
            ...
            stage('SR Daily ML Data Export Tide Point'){
            ...
            stage('SR Daily ML Data Export Single Universe Customers'){
        ...
        stage('SR Daily ML Data Export Orlin Healthcare'){
        ...
        stage('SR Daily ML Data Export JPM'){
        ...
        stage('SR Daily Multijob Customer Post Universe Phase'){
            stage('SR DAILY ML Final Customer Jobs'){
        ...
        stage('SR Daily ML Regime Vision Phase'){
            stage('SR Daily ML Regime Vision'){
        ...
        stage('SR Daily Post Site Update Phase'){
            stage('SR Daily Post Site Update'){
        ...
        stage('SR Daily ML Data Aggregator Orlin'){
